...
//import axolotl.spring.AxolotlDB.model.ChangeContr_cliente;
...
private final ClientesService clientesService;
	...
	public Clientes addClientes(@RequestBody Clientes clientes) {
	 ...
	 public Clientes updateClientes(@PathVariable("Id_Clientes") Long id_Clientes,
		   ...
		   return clientesService.updateClientes(id_Clientes, nom_cliente, app_cliente, email_cliente, cel_cliente, contr_cliente);
	 }//updateClientes
